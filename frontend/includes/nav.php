...
<aside class="w-56 shrink-0 bg-white dark:bg-slate-900 border-r border-gray-200/80 dark:border-slate-800 flex flex-col h-screen sticky top-0">
    ...
    <nav class="flex-1 px-3 space-y-0.5">
        <a href="index.php"
           class="sidebar-link flex items-center gap-3 px-3 py-2 text-[13px] <?= $currentPage === 'index.php' ? 'active text-gray-900 dark:text-white' : 'text-gray-500 dark:text-slate-400' ?>">
        ...
        <a href="skelbiu.php"
           class="sidebar-link flex items-center gap-3 px-3 py-2 text-[13px] <?= $currentPage === 'skelbiu.php' ? 'active text-gray-900 dark:text-white' : 'text-gray-500 dark:text-slate-400' ?>">
            <span class="w-2 h-2 rounded-full bg-emerald-500"></span>
            Skelbiu.lt
        </a>
        <a href="autoplius.php"
           class="sidebar-link flex items-center gap-3 px-3 py-2 text-[13px] <?= $currentPage === 'autoplius.php' ? 'active text-gray-900 dark:text-white' : 'text-gray-500 dark:text-slate-400' ?>">
            <span class="w-2 h-2 rounded-full bg-blue-500"></span>
            Autoplius.lt
        </a>
        <a href="aruodas.php"
           class="sidebar-link flex items-center gap-3 px-3 py-2 text-[13px] <?= $currentPage === 'aruodas.php' ? 'active text-gray-900 dark:text-white' : 'text-gray-500 dark:text-slate-400' ?>">
    ...
    <div class="px-3 py-4 border-t border-gray-100 dark:border-slate-800 space-y-3">
        ...
        <div class="flex items-center justify-between px-3">
            ...
            <a href="login.php?action=logout" class="text-gray-400 dark:text-slate-500 hover:text-gray-600 dark:hover:text-slate-300 transition-colors" title="Atsijungti">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg>
            </a>
        </div>
        <?php else: ?>
        <a href="login.php" class="flex items-center justify-center px-3 py-2 rounded-lg bg-gray-900 dark:bg-white hover:bg-gray-800 dark:hover:bg-gray-100 text-white dark:text-gray-900 text-[13px] font-medium transition-colors">
            Prisijungti
        </a>
        <?php endif; ?>
    </div>
