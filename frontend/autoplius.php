        ...
        <div class="w-full max-w-lg mx-4 rounded-2xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form class="space-y-4">
                <div>
                    ...
                    <input type="text" placeholder="pvz. Audi A4 Avant" class="w-full bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg px-4 py-2.5 text-sm text-gray-900 dark:text-slate-100 focus:outline-none focus:border-<?= $meta['color'] ?>-500">
                </div>
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="pvz. Passat, RAV4..." class="w-full bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg px-4 py-2.5 text-sm text-gray-900 dark:text-slate-100 focus:outline-none focus:border-<?= $meta['color'] ?>-500">
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-3">
                    <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="number" placeholder="2015" min="1990" max="2026" class="w-full bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg px-4 py-2.5 text-sm text-gray-900 dark:text-slate-100 focus:outline-none focus:border-<?= $meta['color'] ?>-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-600 dark:text-slate-400 mb-1">Rida iki (km)</label>
                        <input type="number" placeholder="200000" class="w-full bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg px-4 py-2.5 text-sm text-gray-900 dark:text-slate-100 focus:outline-none focus:border-<?= $meta['color'] ?>-500">
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-3">
                    <div>
