...
<aside class="w-56 shrink-0 bg-white border-r border-gray-200/80 flex flex-col h-screen sticky top-0">
    ...
    <nav class="flex-1 px-3 space-y-0.5">
        <a href="/"
           class="sidebar-link flex items-center gap-3 px-3 py-2 text-[13px] <?= $requestPath === '/' ? 'active text-gray-900' : 'text-gray-500' ?>">
        ...
        <a href="/skelbiu"
           class="sidebar-link flex items-center gap-3 px-3 py-2 text-[13px] <?= $requestPath === '/skelbiu' ? 'active text-gray-900' : 'text-gray-500' ?>">
            <span class="w-2 h-2 rounded-full bg-emerald-500"></span>
            Skelbiu.lt
        </a>
        <a href="/autoplius"
           class="sidebar-link flex items-center gap-3 px-3 py-2 text-[13px] <?= $requestPath === '/autoplius' ? 'active text-gray-900' : 'text-gray-500' ?>">
            <span class="w-2 h-2 rounded-full bg-blue-500"></span>
            Autoplius.lt
        </a>
        <a href="/aruodas"
           class="sidebar-link flex items-center gap-3 px-3 py-2 text-[13px] <?= $requestPath === '/aruodas' ? 'active text-gray-900' : 'text-gray-500' ?>">
    ...
    <div class="px-3 py-4 border-t border-gray-100">
        ...
        <div class="flex items-center justify-between px-3">
            ...
            <a href="/login?action=logout" class="text-gray-400 hover:text-gray-600 transition-colors" title="Atsijungti">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg>
            </a>
        </div>
        <?php else: ?>
        <a href="/login" class="flex items-center justify-center px-3 py-2 rounded-lg bg-gray-900 hover:bg-gray-800 text-white text-[13px] font-medium transition-colors">
            Prisijungti
        </a>
        <?php endif; ?>
    </div>
